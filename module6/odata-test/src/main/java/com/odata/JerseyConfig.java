...
public class JerseyConfig extends ResourceConfig {
    ...
    public JerseyConfig(PersonODataJPAServiceFactory serviceFactory, EntityManagerFactory emf) {
        ...
        register(new PersonRootLocator(serviceFactory));
    ...
    @Path("/")
    public static class PersonRootLocator extends ODataRootLocator {

        private PersonODataJPAServiceFactory serviceFactory;

        public PersonRootLocator(PersonODataJPAServiceFactory serviceFactory) {
