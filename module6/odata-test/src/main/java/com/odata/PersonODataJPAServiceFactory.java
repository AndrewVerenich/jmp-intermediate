...
@Component
public class PersonODataJPAServiceFactory extends ODataJPAServiceFactory {

    private static final Logger log = LoggerFactory.getLogger(PersonODataJPAServiceFactory.class);

    public PersonODataJPAServiceFactory() {
